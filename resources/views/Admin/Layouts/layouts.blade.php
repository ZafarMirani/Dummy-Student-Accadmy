        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li >
                        <a href="{{ url('dashboard') }}" ><i class="menu-icon fa fa-laptop active"></i>Dashboard </a>
                        <a href="{{ url('students') }}"><i class=" menu-icon fa fa-users"></i>Students </a>
                        <a href="{{ url('pay-fees') }}"><i class="menu-icon fa fa-dollar"></i> Pay Fees </a>
                        {{--  <a href="{{ url('students') }}"><i class="menu-icon fa fa-ruble"></i>Payments </a>  --}}
                    </li>
    ...
    <div id="right-panel" class="right-panel">
      ...
      <footer class="site-footer ">
        <div class="footer-inner" >
            <div class="row p-4" style="background-color: #e9d9d9 ">
                <div class="col-sm-6">
                    Copyright &copy; SOFTWEBIES
                </div>
                <div class="col-sm-6 text-right">
                    Designed by <a href="https://colorlib.com">Zafar Mirani</a>
                </div>
            </div>
        </div>
    </footer>
